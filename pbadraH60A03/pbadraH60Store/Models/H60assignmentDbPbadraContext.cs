...
public partial class H60assignmentDbPbadraContext :  IdentityDbContext<IdentityUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Product>().HasData(
            ...
            new Product { ProductId = 14, ProdCatId = 4, Description = "Princess V60", Manufacturer = "Princess Yachts", Stock = 1, BuyPrice = 925000.00m, SellPrice = 975000.00m },
            ...
            new Product { ProductId = 16, ProdCatId = 4, Description = "Azimut S6", Manufacturer = "Azimut", Stock = 1, BuyPrice = 900000.00m, SellPrice = 950000.00m },
