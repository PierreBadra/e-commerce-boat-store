...
namespace pbadraH60A01.Migrations
{
    ...
    [Migration("20241015235059_UserIdColumnAddOnCustomerTable")]
    partial class UserIdColumnAddOnCustomerTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("pbadraH60A01.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderId = 1,
                            CustomerId = 1,
                            DateCreated = new DateTime(2024, 10, 15, 23, 50, 58, 734, DateTimeKind.Utc).AddTicks(7966),
                            DateFulfilled = new DateTime(2024, 10, 15, 23, 50, 58, 734, DateTimeKind.Utc).AddTicks(7967),
                            Taxes = 13999.99m,
                            Total = 139999.97m
                        });
                });
            ...
            modelBuilder.Entity("pbadraH60A01.Models.ShoppingCart", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CartId = 1,
                            CustomerId = 2,
                            DateCreated = new DateTime(2024, 10, 15, 23, 50, 58, 734, DateTimeKind.Utc).AddTicks(7917)
                        });
                });
