...
namespace pbadraH60Customer.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<IdentityUser> signInManager, ILogger<LoginModel> logger, ICustomerRepository customerRepository, UserManager<IdentityUser> userManager)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (customers.Any()) {
                ...
                if (customer == null) {
                    ModelState.AddModelError("Input.Password", "Only customers are allowed");
                }
            }
            else {
                ModelState.AddModelError("Input.Password", "No customer account found");
            }
